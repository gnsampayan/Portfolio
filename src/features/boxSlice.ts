...
const initialState: BoxState[] = [
  ...
  { id: 6, x: '0', y: '0', opacity: 1, animate: false, transitioning: false, clickable: true, xCoord: '0', yCoord: '0' },
  ...
  { id: 12, x: '0', y: '0', opacity: 1, animate: false, transitioning: false, clickable: true, xCoord: '0', yCoord: '0' },
];
